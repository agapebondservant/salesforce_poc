...
class DataCollectionProcessor:
    ...
    def process(self, input_dir, output_dir, table_dir, file_extension="md") -> tuple[list, list, list]:
        """
        ...
        input_subdirs = [subdir for subdir in input_subdirs if glob.glob(f"{subdir}/*.{file_extension}")]
